  ...
  return (
    <div className="max-w-4xl mx-auto animate-fadeIn pb-16">
      <div className="mb-8">
        ...
        <p className="text-slate-500 font-medium">Expediente Clínico Clinica Base</p>
      </div>
              ...
              <div className="bg-slate-100 border border-slate-200 rounded-3xl p-5 md:p-7">
                <div className="mx-auto bg-white w-full max-w-[760px] min-h-[980px] p-8 md:p-10 border border-slate-200 shadow-sm flex flex-col">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h4 className="text-5xl font-black text-emerald-500 tracking-tight leading-none">Clinica Base</h4>
                    ...
                    <div className="text-right pt-1">
                      <p className="text-4xl font-black text-slate-900 leading-tight">Dr(a). Responsable</p>
                  ...
                  <div className="mt-auto pt-10 flex items-end justify-between gap-10">
                    ...
                    <div className="w-[42%] text-center">
                      ...
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.16em]">Dr(a). Responsable<br />Clinica Base</p>
                    </div>
                  </div>
                </div>
              </div>
